          ...
          <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-8 shadow-xl">
            ...
            <div className="space-y-8">
              ...
              <div className="p-6 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20 shadow-sm">
                <h3 className="text-2xl font-heading font-bold text-white mb-4">Basic Information</h3>
                <div className="space-y-4">
                  <div>
                    <h4 className="text-lg font-semibold text-white mb-2">{portfolio.name}</h4>
                    <p className="text-xl text-gray-200 font-semibold mb-2">{portfolio.job_title}</p>
                    <p className="text-gray-300 font-medium">{portfolio.title}</p>
                  </div>
                  {portfolio.description && (
                    <div className="pt-4 border-t border-white/20">
                      <h5 className="text-md font-semibold text-white mb-2">About</h5>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {portfolio.website_url && (
                      <div className="flex items-center space-x-3 p-3 bg-white/5 rounded-lg">
                        ...
                        <div>
                          ...
                          <a href={portfolio.website_url} target="_blank" rel="noopener noreferrer" className="text-white hover:text-brand-300 transition-colors">
                            {portfolio.website_url}
                          </a>
                        </div>
                      </div>
                    ...
                    {portfolio.github_url && (
                      <div className="flex items-center space-x-3 p-3 bg-white/5 rounded-lg">
                        ...
                        <div>
                          ...
                          <a href={portfolio.github_url} target="_blank" rel="noopener noreferrer" className="text-white hover:text-brand-300 transition-colors">
                            {portfolio.github_url}
                          </a>
                        </div>
                      </div>
                    ...
                    {portfolio.linkedin_url && (
                      <div className="flex items-center space-x-3 p-3 bg-white/5 rounded-lg">
                        ...
                        <div>
                          ...
                          <a href={portfolio.linkedin_url} target="_blank" rel="noopener noreferrer" className="text-white hover:text-brand-300 transition-colors">
                            {portfolio.linkedin_url}
                          </a>
                        </div>
                      </div>
                    ...
                    {portfolio.additional_links?.map((link, index) => (
                      <div key={index} className="flex items-center space-x-3 p-3 bg-white/5 rounded-lg">
                        ...
                        <div>
                          <p className="text-sm text-gray-300">{link.label}</p>
                          <a href={link.url} target="_blank" rel="noopener noreferrer" className="text-white hover:text-brand-300 transition-colors">
                            {link.url}
                          </a>
                        </div>
                      </div>
              ...
              {portfolio.skills && portfolio.skills.length > 0 && (
                <div className="p-6 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20 shadow-sm">
                  <h3 className="text-xl font-heading font-bold text-white mb-6">Skills & Expertise</h3>
                  <div className="flex flex-wrap gap-3">
                    {portfolio.skills.map((skill, index) => {
                      ...
                      return (
                        <span
                          key={index}
                          className={`${colorClass} px-4 py-2 rounded-xl text-sm font-semibold border shadow-md`}
                        >
                          {skill}
                        </span>
                      );
              ...
              {portfolio.projects && portfolio.projects.length > 0 && (
                <div className="p-6 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20 shadow-sm">
                  <h3 className="text-xl font-heading font-bold text-white mb-6">Featured Projects</h3>
                  <div className="grid gap-4">
                    {portfolio.projects.map((project, index) => (
                      <div key={index} className="p-4 bg-white/5 rounded-lg border border-white/10">
                        ...
                        <a
                          ...
                          className="inline-flex items-center text-brand-300 hover:text-brand-200 transition-colors text-sm"
                        >
                          View Project
